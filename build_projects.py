...
MAILTO = ("mailto:mehenuf@gmail.com?subject=R%C3%A9sum%C3%A9%20request%20-%20portfolio"
...
<meta property="og:title" content="{title} - Md. Mehenuf Hossain Bhuiyan">
<meta property="og:description" content="{desc}">
<meta property="og:type" content="article">
<meta property="og:url" content="https://mehenuf.github.io/projects/{slug}">
<meta property="og:image" content="https://mehenuf.github.io/assets/img/profile-mehenuf.jpg">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="{title} - Md. Mehenuf Hossain Bhuiyan">
<meta name="twitter:description" content="{desc}">
<meta name="twitter:image" content="https://mehenuf.github.io/assets/img/profile-mehenuf.jpg">
...
AUTOMATION_MAILTO = (
    "mailto:mehenuf@gmail.com?subject=Patient%20Care%20OS%20-%20full%20report%20request"
    "&body=Hi%20Mehenuf%2C%0A%0AI%27d%20like%20to%20see%20the%20full%20write-up%20for%20the%20"
    "Patient%20Care%20Operating%20System%20project%20-%20the%20ClickUp%20build%20guide%2C%20"
...
PAGES["car-rental-platform.html"] = dict(
    ...
    body=(
        ...
        section("From the app",
                ...
                "",
                gallery([
                    ("../assets/img/car-rental/homepage-desktop.jpg", "BestCar homepage on desktop showing the vehicle inventory grid",
                     "Homepage - desktop", "The customer-facing inventory grid, filterable by category and price."),
                    ("../assets/img/car-rental/homepage-mobile.jpg", "BestCar homepage on mobile",
                     "Homepage - mobile", "The same inventory browsing experience, responsive down to mobile."),
                    ("../assets/img/car-rental/chat-widget.jpg", "The chat assistant recommending real vehicles with picture cards",
                     "Chat assistant in use", "A grounded recommendation - every card links to a real vehicle detail page."),
                    ("../assets/img/car-rental/admin-dashboard-desktop.jpg", "Admin dashboard on desktop showing revenue, bookings, and AI-scored leads",
                     "Admin dashboard - desktop", "Revenue, best-sellers, and the lead-quality panel, ordered by AI score."),
                    ("../assets/img/car-rental/admin-dashboard-mobile.jpg", "Admin dashboard on mobile",
                     "Admin dashboard - mobile", "The same operational view, responsive for staff checking in from a phone."),
                    ("../assets/img/car-rental/automation-hot-lead-execution.jpg", "n8n execution log for a lead scored and routed as hot",
                     "n8n - hot lead execution", "A scored conversation routed as a hot lead, logged in the live n8n execution history."),
                    ("../assets/img/car-rental/automation-cold-lead-execution.jpg", "n8n execution log for a lead scored and routed as cold",
                     "n8n - cold lead execution", "The same workflow branching to the cold-lead path for a lower-scored conversation."),
                    ("../assets/img/car-rental/automation-google-sheet-rows.jpg", "Rows appended to the Google Sheet by the n8n automation",
